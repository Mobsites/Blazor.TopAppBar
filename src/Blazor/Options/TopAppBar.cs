    ...
    public partial class TopAppBar
    {
        internal class Options : StatefulComponentOptions
        {
            ...
            ***********************************************************************/
            ...
            public TopAppBarHeader.Options TopAppBarHeader { get; set; }
            public TopAppBarHeaderLogo.Options TopAppBarHeaderLogo { get; set; }
            public TopAppBarHeaderTitle.Options TopAppBarHeaderTitle { get; set; }
            public TopAppBarActions.Options TopAppBarActions { get; set; }
        }
    }
}